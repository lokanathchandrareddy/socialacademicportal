...
let professorNameLengthChecker = (professorName) => {
  // Check if e-mail exists
  if (!professorName) {
    return false; // Return error
  } else {
...
const professorNameValidators = [
  // First professorName Validator
  {
    validator: professorNameLengthChecker,
    message: 'Professor Name should be given'
  },
...
const blogSchema = new Schema({
  ...
  professorName: {
    type: String,
    required: true,
    validate: professorNameValidators
  },
